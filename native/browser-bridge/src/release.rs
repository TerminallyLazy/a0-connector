...
pub const PINNED_RELEASE_CATALOGS: &[PinnedReleaseCatalog] = &[PinnedReleaseCatalog {
    release: "2.12.0",
    catalog_url: "https://raw.githubusercontent.com/TerminallyLazy/agent-zero-browser-releases/native-v2.12.0-macos-r2/catalog.json",
    signature_url: "https://raw.githubusercontent.com/TerminallyLazy/agent-zero-browser-releases/native-v2.12.0-macos-r2/catalog.sig",
}];
...
pub const PINNED_BUILD_PROVENANCE: &[PinnedBuildProvenance] = &[PinnedBuildProvenance {
    ...
    statement_url: "https://raw.githubusercontent.com/TerminallyLazy/agent-zero-browser-releases/native-v2.12.0-macos-r2/provenance-macos-universal2.json",
    signature_url: "https://raw.githubusercontent.com/TerminallyLazy/agent-zero-browser-releases/native-v2.12.0-macos-r2/provenance-macos-universal2.sig",
}];
